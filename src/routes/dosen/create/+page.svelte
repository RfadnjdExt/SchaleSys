...
>
	<div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
		<div class="flex items-center space-x-8">
			...
			>
				<span class="text-slate-500">System / Lecturers / Create</span>
			</div>
		</div>
...
<div class="max-w-4xl mx-auto px-4 py-12 relative z-10">
	<div class="mb-8">
		...
		>
			New<br />
			<span class="text-primary">Lecturer Entry</span>
		</h1>
	</div>
			...
			<form method="POST" class="space-y-6" use:enhance>
				<div>
					...
					<input
						...
						placeholder="Ex: 198501012010121001"
						required
					/>
				</div>
				...
				<div>
					...
					<input
						...
						id="nama_dosen"
						name="nama_dosen"
						bind:value={nama_dosen}
						class="w-full bg-slate-50 dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-600 focus:border-primary dark:focus:border-primary p-4 font-mono text-slate-900 dark:text-white outline-none transition-colors"
						placeholder="Ex: Dr. Budi Santoso, M.Kom."
						required
					/>
				</div>

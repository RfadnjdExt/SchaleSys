...
>
	<div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
		<div class="flex items-center space-x-8">
			...
			>
				<span class="text-slate-500">System / Students / Create</span>
			</div>
		</div>
...
<div class="max-w-4xl mx-auto px-4 py-12 relative z-10">
	<div class="mb-8">
		...
		>
			New<br />
			<span class="text-primary">Student Entry</span>
		</h1>
	</div>
		...
		<div class="p-8">
			...
			<form method="POST" class="space-y-6" use:enhance>
				...
				<div class="pt-6 flex gap-4">
					...
					<!-- Batal is handled by the nav Back button essentially, but acceptable to have here -->
				</div>
			</form>
		</div>
	</div>

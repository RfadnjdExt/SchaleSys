<script lang="ts">
    ...
    // Local state for bind:value
    let kode_mk = $state("");
    let nama_mk = $state("");
    // Use undefined for numbers to keep input empty initially
    let sks: number | undefined = $state();
    let semester: number | undefined = $state();
    let hari = $state("");
    let jam_mulai = $state("");
    let jam_selesai = $state("");
    let ruangan = $state("");
</script>
...
>
    <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div class="flex items-center space-x-8">
            ...
            >
                <span class="text-slate-500">System / Courses / Create</span>
            </div>
        </div>
...
<div class="max-w-5xl mx-auto px-4 py-12 relative z-10">
    <div class="mb-8">
        ...
        >
            New<br />
            <span class="text-primary">Course Entry</span>
        </h1>
    </div>
    ...
    >
        ...
        <div
            class="bg-slate-100 dark:bg-slate-800 px-8 py-4 border-b-4 border-slate-900 dark:border-white"
        >
            <h2
                class="font-display text-lg tracking-widest uppercase text-slate-700 dark:text-slate-300 flex items-center"
            >

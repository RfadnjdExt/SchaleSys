...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let nama_mk, sks, semester, hari, jam_mulai, jam_selesai, ruangan;
    let data = $$props["data"];
    let form = $$props["form"];
